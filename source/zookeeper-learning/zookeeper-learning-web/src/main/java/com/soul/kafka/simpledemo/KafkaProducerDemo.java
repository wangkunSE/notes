...
public class KafkaProducerDemo extends Thread {
    ...
    public void run() {
        for (int i = 0; i < 100; i++) {
            producer.send(new KeyedMessage<String, String>("foo", i+"", "message" + i));
        }
        try {
            Thread.sleep(5000);
    ...
    private static Properties getProperties() {
        Properties props = new Properties();
        props.put("metadata.broker.list", "192.168.154.152:9092,192.168.154.152:9093,192.168.154.152:9094");
